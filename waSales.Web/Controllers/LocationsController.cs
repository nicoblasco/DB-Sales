...
namespace waSales.Web.Controllers
{
    ...
    public class LocationsController : ControllerBase
    {
        ...
        public LocationsController(DbContextApp context)
        {
            _context = context;
        }
        ...
        // GET: api/Locations/5
        [HttpGet("{companyId}")]
        public IEnumerable<Location> GetLocations([FromRoute] int companyId)
        {
            return _context.Locations.Where(x => x.Enabled == true && x.CompanyId == companyId);
        }
        ...
        public async Task<IActionResult> Update([FromBody] UpdateViewModel model)
        {
            ...
            var modelo = await _context.Locations.FirstOrDefaultAsync(x => x.Id == model.Id);
