...
namespace waSales.Web.Controllers
{
    ...
    public class PaymentMethodsController : ControllerBase
    {
        ...
        public PaymentMethodsController(DbContextApp context)
        {
            _context = context;
        }
        ...
        [HttpGet("{companyId}")]
        public IEnumerable<PaymentMethod> GetPaymentMethods([FromRoute] int companyId)
        {
            return _context.PaymentMethods.Where(x => x.Enabled == true && x.CompanyId == companyId);
        }
        ...
        public async Task<IActionResult> Create([FromBody] CreateViewModel model)
        {
            ...
            PaymentMethod modelo = new PaymentMethod
            {
            ...
            _context.PaymentMethods.Add(modelo);
            try
            {
        ...
        public async Task<IActionResult> Update([FromBody] UpdateViewModel model)
        {
            ...
            var modelo = await _context.PaymentMethods.FirstOrDefaultAsync(x => x.Id == model.Id);
        ...
        // PUT: api/PaymentMethods/Delete/5
        [HttpPut("[action]")]
