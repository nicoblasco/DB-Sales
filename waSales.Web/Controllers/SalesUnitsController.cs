...
namespace waSales.Web.Controllers
{
    ...
    public class SalesUnitsController : ControllerBase
    {
        ...
        public SalesUnitsController(DbContextApp context)
        {
            _context = context;
        }
        ...
        [HttpGet("{companyId}")]
        public IEnumerable<SalesUnit> GetSalesUnits([FromRoute] int companyId)
        {
            return _context.SalesUnits.Where(x => x.Enabled == true && x.CompanyId == companyId);
        }
        ...
        public async Task<IActionResult> Update([FromBody] UpdateViewModel model)
        {
            ...
            var modelo = await _context.SalesUnits.FirstOrDefaultAsync(x => x.Id == model.Id);
