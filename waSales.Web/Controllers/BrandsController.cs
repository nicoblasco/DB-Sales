...
namespace waSales.Web.Controllers
{
    ...
    public class BrandsController : ControllerBase
    {
        ...
        public BrandsController(DbContextApp context)
        {
            _context = context;
        }
        ...
        // GET: api/Brands/5
        [HttpGet("{companyId}")]
        public IEnumerable<Brand> GetBrands([FromRoute] int companyId)
        {
            return _context.Brands.Where(x => x.Enabled == true && x.CompanyId == companyId);
        }
        ...
        public async Task<IActionResult> Update([FromBody] UpdateViewModel model)
        {
            ...
            var modelo = await _context.Brands.FirstOrDefaultAsync(x => x.Id == model.Id);
